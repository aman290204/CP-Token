...
# API Configuration
API_ID = int(os.environ.get("API_ID", "22117815").strip())
API_HASH = os.environ.get("API_HASH", "f78352d2ffdf2082f1d5a627ec1cf542").strip()
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8530004520:AAHjbfR4mubkZsCB6l4jV64IH0tpEzjC2x4").strip()

CREDIT = os.environ.get("CREDIT", "𝐈𝐓'𝐬𝐆𝐎𝐋𝐔")
# MongoDB Configuration
DATABASE_NAME = os.environ.get("DATABASE_NAME", "CpprivateApi")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://missioncfa8:0ZOrlLXrmMghknbB@cluster0.cqoxvuo.mongodb.net/?appName=Cluster0")
MONGO_URL = DATABASE_URL  # For auth system

# Owner and Admin Configuration
OWNER_ID = int(os.environ.get("OWNER_ID", "5036234797"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "5036234797 7977408354").split()]
